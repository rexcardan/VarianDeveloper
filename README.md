...
* **[04/10/2015]** Corrected version of [RBEReport](https://variandeveloper.codeplex.com/SourceControl/latest#Eclipse Scripting API/projects/RBEReport/). See the version [comment](https://variandeveloper.codeplex.com/SourceControl/changeset/38243).  
* **[04/01/2015]** Added code from Varian Research Symposium 2015 - [TCP / NTCP Calculator Script](https://variandeveloper.codeplex.com/SourceControl/latest#Research Symposium 2015/Eclipse Scripting API/Plugins/EUDScript.cs) and [Automated Planning Demo](https://variandeveloper.codeplex.com/SourceControl/latest#Research Symposium 2015/Eclipse Scripting API/Projects/AutomatedPlanningDemo/AutomatedPlanningDemo.cs).

* **[03/03/2015]** New project [ExportBatchDVHs](https://variandeveloper.codeplex.com/SourceControl/latest#Eclipse Scripting API/projects/ExportBatchDVHs/ExportBatchDVHs.cs) demonstrates exporting DVHs in batch mode.  
...
* **[02/14/2014]** New project [GetDicomCollection](https://variandeveloper.codeplex.com/SourceControl/latest#plugins/GetDicomCollection.cs), new article [Scripting the DICOM Daemon](https://variandeveloper.codeplex.com/wikipage?title=Scripting%20the%20Varian%20DICOM%20DB%20Daemon%20with%20ESAPI%20%2b%20DCMTK).  
* **[01/21/2014]** See [Source Control](https://variandeveloper.codeplex.com/SourceControl/latest) page; added new GenerateWebDVH project.
